...
# Load the data
df = pd.read_csv(r"C:\Users\ADMIN\Desktop\MARINA\US_Regional_Sales_Data.csv", encoding='latin-1')
...
st.write(f"The X-axis represents 'Unit Price', and the Y-axis represents '_ProductID'.")
st.write(f"Number of Bins selected: {num_bins}")

# Create the histogram 
fig3 = px.histogram(df, x='Unit Price', nbins=num_bins, title=f'Unit Price vs. _ProductID')
